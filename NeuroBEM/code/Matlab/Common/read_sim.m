function data_sim = read_sim(filename, bodyframe)
%data_traj: reads a trajectory file
% data = read_sim(fname, B) reads the simulation run named fname into the matrix
...
data_sim = fun_rotate_vel(data_sim);
data_sim = fun_rotate_acc(data_sim);
end